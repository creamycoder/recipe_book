...
5. Настройте файл `.env` для подключения к базе данных, как показано на скриншоте.
![image](https://github.com/user-attachments/assets/b6fa88aa-e5d5-4c2c-9f50-344accbca7b6)
6. Откройте консоль OpenServer, перейдите в папку проекта, и выполните следующие команды:
7. Установите зависимости командой `composer install`.
8. Сгенерируйте ключ с помощью `php artisan key:generate`.
9. Выполните миграции командой `php artisan migrate`.
